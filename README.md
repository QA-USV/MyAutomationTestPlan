...
|------------------------------------------------|---|---|
| Подготовка тест-кейсов                         | QA_Engineer | 4 чел./ч |
| Написание автоматизированных тестов            | QA_Engineer | 8 чел./ч |
| Исполнение автоматизированных тестов           | QA_Engineer | 4 чел./ч |
| Подготовка отчета о тестировании, баг-репортов | QA_Engineer | 4 чел./ч |
